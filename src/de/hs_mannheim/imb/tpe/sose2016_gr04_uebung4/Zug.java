...
/**
 * Klasse Zug stellt die Züge die auf einer Strecke 
 * fahren da, als Threads
 * mit den Eigenschaften Name, Position; Strecke auf der er fährt 
 * und die tatsächliche Geschwindigkeit die in km/sec umgerechnet wird 
 */
public class Zug implements Runnable{
	...
	/**
	 * Konstruktor 
	 * @param name , Kennung des Zuges
	 * @param startPosi, Startposition auf der Strecke
	 * @param speed, Geschwindigkeit von km/h in km/sec umgerechnet
	 * @param u , Strecke auf der der Zug fährt
	 */
	...
	/**
	 * überschriebene run()Methode des Interface von Runnable 
	 * 
	 */
	@Override
